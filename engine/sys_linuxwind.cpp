...
//
// Purpose: Linux and Emscripten support for the IGame interface
//
// $Workfile:     $
// $Date:         $
// $NoKeywords: $
...
public:
	...
	// Somehow I am going to have to convert Windows -> Browser Tabs, and since
	// I have like no experience with Emscripten (yes, this is my first project) I will have to fix this for years.
	// EDIT: Nevermind!
