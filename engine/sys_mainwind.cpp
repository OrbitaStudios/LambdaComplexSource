...
#include "SDL_syswm.h"
#else
#include "../thirdparty/EmSDL2/include/SDL.h"
#include "../thirdparty/EmSDL2/include/SDL_syswm.h"
...
bool CGame::CreateGameWindow( void )
{
	...
	// Browser's can't use CommandLine arguments, so we'll have to remove the feature
