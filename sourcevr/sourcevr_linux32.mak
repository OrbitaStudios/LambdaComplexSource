...
$(OBJ_DIR)/memoverride.o : $(abspath ../public/tier0/memoverride.cpp) $(PWD)/sourcevr_linux32.mak $(SRCROOT)/devtools/makefile_base_emscripten.mak $(OTHER_DEPENDENCIES)
	$(PRE_COMPILE_FILE)
...
$(OBJ_DIR)/sourcevirtualreality.o : $(abspath ../sourcevr/sourcevirtualreality.cpp) $(OBJ_DIR)/cbase.h.gch $(OBJ_DIR)/cbase.h $(PWD)/sourcevr_linux32.mak $(SRCROOT)/devtools/makefile_base_emscripten.mak
	$(PRE_COMPILE_FILE)
...
$(OBJ_DIR)/cbase.h.gch : cbase.h $(PWD)/sourcevr_linux32.mak $(SRCROOT)/devtools/makefile_base_emscripten.mak $(OTHER_DEPENDENCIES)
	$(PRE_COMPILE_FILE)
...
$(OBJ_DIR)/cbase.h : cbase.h $(OBJ_DIR)/cbase.h.gch $(PWD)/sourcevr_linux32.mak $(SRCROOT)/devtools/makefile_base_emscripten.mak
	cp -f $< $(OBJ_DIR)/cbase.h

$(OBJ_DIR)/stdafx.o : $(abspath ../sourcevr/stdafx.cpp) $(PWD)/sourcevr_linux32.mak $(SRCROOT)/devtools/makefile_base_emscripten.mak $(OTHER_DEPENDENCIES)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
