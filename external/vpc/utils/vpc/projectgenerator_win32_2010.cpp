...
//#else
//		const char *pTargetPlatformName = g_pVPC->IsPlatformDefined( "Emscripten" )
//#endif
...
bool CProjectGenerator_Win32_2010::WritePrimaryXML( const char *pOutputFilename )
{
	...
	m_XMLWriter.PushNode( "<PlatformToolset>emscripten</PlatformToolset>" );
	m_XMLWriter.PushNode( "<CLToolExe>em++.bat</CLToolExe>" );
	m_XMLWriter.PushNode( "<LinkToolExe>emcc.bat</LinkToolExe>" );
#endif
