...
void CVPC::SetupDefaultConditionals()
{
	...
	//
	{
		...
		// Emscripten should be its own platform. Since it is only tunning in the browser not the machine.
		FindOrCreateConditional( "EMSCRIPTEN", true, CONDITIONAL_PLATFORM );
	#endif
