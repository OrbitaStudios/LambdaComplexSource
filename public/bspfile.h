...
// Mohamed Ashraf: Make sure to decrease common limits, as the browser has a minimum amount of access to RAM.
...
#else
#define MAX_MAP_WORLDLIGHTS				2048
#endif
